...
public class GetTicketFromScanActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_get_ticket_from_scan);
		qrScan();
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_get_ticket_from_scan, menu);
		return true;
	}
